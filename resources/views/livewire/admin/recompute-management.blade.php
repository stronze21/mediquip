<div>
    {{-- Page Header --}}
    <x-mary-header title="Recompute Return Totals" subtitle="Fix incorrect returned quantity calculations"
        separator />
        ...
        <div class="flex items-start gap-3">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-gray-700">
                    This tool recalculates sale item returned quantities based on actual processed returns.
    ...
    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
        ...
        <x-mary-card>
            <div class="space-y-4">
                ...
                <div class="space-y-2">
                    <x-mary-button wire:click="runRecompute(true)" class="w-full btn-outline btn-info btn-sm"
                    ...
                    <x-mary-button wire:click="runRecompute(false)" class="w-full btn-info btn-sm"
                        wire:loading.attr="disabled" wire:target="runRecompute">
